...
public class Solution024_1 {
	public String[] solution(String[] players, String[] callings) {
		// 선수 이름을 키로, 등수를 값으로 저장하는 Map
		...
		for (String calledPlayer : callings) {
			...
			if (currentRank > 0) {
				...
				// Map의 등수 정보 업데이트
				rankMap.put(calledPlayer, currentRank - 1);
	...
	public static void main(String[] args) {
		Solution024_1 solution = new Solution024_1();
		String[] players = { "one", "dos", "tre" };
		String[] callings = { "dos", "tre", "dos" };
